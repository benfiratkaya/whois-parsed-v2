...
async function testNotAvailable(base, tld, options = {}) {
  ...
  // console.log (result);
  if (tld === ".рф") {
    // this gets translated to puny code
  ...
  if (
    !(
      options.hasOwnProperty("excludedFields") &&
      options.excludedFields.includes("expirationDate")
    )
  ) {
  ...
  if (
    !(
      options.hasOwnProperty("excludedFields") &&
      options.excludedFields.includes("creationDate")
    )
  ) {
  ...
  if (
    !(
      options.hasOwnProperty("excludedFields") &&
      options.excludedFields.includes("updatedDate")
    )
  ) {
  ...
  if (
    !(
      options.hasOwnProperty("excludedFields") &&
      options.excludedFields.includes("status")
    )
  ) {
  ...
  if (
    !(
      options.hasOwnProperty("excludedFields") &&
      options.excludedFields.includes("registrar")
    )
  ) {
...
describe("#whoisParser integration tests", function () {
  ...
  it("known .name should not be available and have data", async function () {
    await testNotAvailable("google", ".name", {
      excludedFields: ["creationDate", "expirationDate", "updatedDate"],
    });
  });
  ...
  it("known .au should not be available and have data", async function () {
    await testNotAvailable("google.com", ".au", {
      excludedFields: ["creationDate", "expirationDate", "updatedDate"],
    });
  });
  ...
  it("known .ru should not be available and have data", async function () {
    await testNotAvailable("google", ".ru", {
      excludedFields: ["updatedDate"],
    });
  });
  ...
  it("known .nl should not be available and have data", async function () {
    await testNotAvailable("google", ".nl", {
      excludedFields: ["creationDate", "expirationDate", "updatedDate"],
    });
  });
  ...
  it("known .br should not be available and have data", async function () {
    await testNotAvailable("google.com", ".br", {
      excludedFields: ["registrar"],
    });
  });
  ...
  it("known .eu should not be available and have data", async function () {
    await testNotAvailable("google", ".eu", {
      excludedFields: [
        "creationDate",
        "expirationDate",
        "updatedDate",
  ...
  it("known .bg should not be available and have data", async function () {
    await testNotAvailable("google", ".bg", {
      excludedFields: [
        "creationDate",
        "expirationDate",
        "updatedDate",
  ...
  it("known .de should not be available and have data", async function () {
    await testNotAvailable("google", ".de", {
      excludedFields: ["creationDate", "expirationDate", "registrar"],
    });
  });
  ...
  it("known .at should not be available and have data", async function () {
    await testNotAvailable("google", ".at", {
      excludedFields: ["creationDate", "expirationDate", "status"],
    });
  });
  ...
  it("known .be should not be available and have data", async function () {
    await testNotAvailable("google", ".be", {
      excludedFields: ["updatedDate", "expirationDate"],
    });
  });
  ...
  it("known .рф should not be available and have data", async function () {
    await testNotAvailable("президент", ".рф", {
      excludedFields: ["updatedDate"],
    });
  });
  ...
  it("known .su should not be available and have data", async function () {
    await testNotAvailable("google", ".su", {
      excludedFields: ["updatedDate"],
    });
  });
  ...
  it("known .is should not be available and have data", async function () {
    await testNotAvailable("google", ".is", {
      excludedFields: ["updatedDate", "status", "registrar"],
    });
  });
  ...
  it("known .tr should not be available and have data", async function () {
    await testNotAvailable("google", ".com.tr", {
      excludedFields: ["nameServers", "updatedDate", "status"],
    });
  });
  it("random .tr domain should be available", async function () {
    await testAvailable(".com.tr", {
      excludedFields: ["nameServers", "updatedDate", "status"],
    });
  });

  it("random tld domain should throw TLD not supported error", () => {
    return whoisWithRetries("google.sdiekdsoclsld").then(
